...
public class BookDAO {
    ...
    public Optional<User> getBookOwner(int id) {
        return jdbcTemplate.query("SELECT User.* FROM Book Join User ON Book.user_id=User.id WHERE Book.id=?", new Object[]{id}, new BeanPropertyRowMapper<>(User.class)).stream().findAny();
    }
